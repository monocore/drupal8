...
namespace Drupal\fr_auth\Authentication\Provider;
...
/**
 * Class ForgerockAuthProvider.
 */
class ForgerockAuthProvider implements AuthenticationProviderInterface {
  ...
  public function applies(Request $request) {
    ...
    return isset($_SERVER['FORGEROCK_USERNAME']);
  }
  ...
  public function authenticate(Request $request) {    
    ...
    if ($this->forgerockAuthenticated($request)) {
      // Return ADMIN user.
  ...
  function forgerockAuthenticated(Request $request){
    kint($request);
    return TRUE;
  }
}
